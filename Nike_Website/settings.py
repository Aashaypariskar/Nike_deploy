"""
Django settings for Nike_Website project.
...
SECRET_KEY = 'django-insecure-w(jldpxb)oi3o6-!-ld=l2#ljrez&!4j*j)5_z0^d&glrjq*c5'
...
ROOT_URLCONF = 'Nike_Website.urls'
...
WSGI_APPLICATION = 'Nike_Website.wsgi.application'
